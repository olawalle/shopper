      ...
      <div className="hidden md:block">
        <div className="border-b border-gray-200 hidden md:block">
          <div className="container mx-auto flex items-center justify-between py-4">
            <div className="flex text-light gap-2" data-testid="nav-location">
              <Image
        ...
        <div className="container mx-auto hidden md:flex items-center justify-between py-4">
          ...
          <div className="w-[500px] mx-8" data-testid="nav-search">
            <AppSearch />
          </div>
        ...
        <div className="bg-[#333333] h-[60px] hidden md:block">
          <div className="container mx-auto h-full flex items-center justify-between">
            <div className="flex items-center h-full" data-testid="nav-menu">
