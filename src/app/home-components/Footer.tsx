  ...
  return (
    <footer className="bg-[#222] text-white py-8">
      <div className="container mx-auto flex gap-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 flex-1 shrink-0">
          <div>
      ...
      <div className="container border-t border-[#323232] flex items-center justify-between mx-auto pt-6 mt-6">
